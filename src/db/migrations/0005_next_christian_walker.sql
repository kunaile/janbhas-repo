...
-- Generated: 2025-09-26T14:56:47.768Z
-- ============================================================================
...
--> statement-breakpoint
DROP INDEX "authors_local_name_idx";--> statement-breakpoint
DROP INDEX "categories_local_name_idx";--> statement-breakpoint
DROP INDEX "articles_published_idx";--> statement-breakpoint
ALTER TABLE "article_tags" ADD COLUMN "created_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "article_tags" ADD COLUMN "updated_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "article_tags" ADD COLUMN "tag_name" varchar(100);--> statement-breakpoint
ALTER TABLE "article_tags" ADD COLUMN "tag_local_name" varchar(100);--> statement-breakpoint
ALTER TABLE "articles" ADD COLUMN "created_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "articles" ADD COLUMN "updated_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "articles" ADD COLUMN "article_type" "article_type" DEFAULT 'standard' NOT NULL;--> statement-breakpoint
...
ALTER TABLE "articles" ADD COLUMN "featured_by" uuid;--> statement-breakpoint
ALTER TABLE "articles" ADD COLUMN "author_name" varchar(255) NOT NULL;--> statement-breakpoint
ALTER TABLE "articles" ADD COLUMN "author_local_name" varchar(255);--> statement-breakpoint
ALTER TABLE "articles" ADD COLUMN "category_name" varchar(255) NOT NULL;--> statement-breakpoint
ALTER TABLE "articles" ADD COLUMN "category_local_name" varchar(255);--> statement-breakpoint
ALTER TABLE "articles" ADD COLUMN "sub_category_name" varchar(255);--> statement-breakpoint
ALTER TABLE "articles" ADD COLUMN "sub_category_local_name" varchar(255);--> statement-breakpoint
ALTER TABLE "authors" ADD COLUMN "created_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "authors" ADD COLUMN "updated_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "categories" ADD COLUMN "created_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "categories" ADD COLUMN "updated_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "languages" ADD COLUMN "created_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "languages" ADD COLUMN "updated_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "newsletter_subscribers" ADD COLUMN "created_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "newsletter_subscribers" ADD COLUMN "updated_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "sub_categories" ADD COLUMN "created_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "sub_categories" ADD COLUMN "updated_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "tags" ADD COLUMN "created_by" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "tags" ADD COLUMN "updated_by" uuid NOT NULL;--> statement-breakpoint
...
ALTER TABLE "articles" DROP COLUMN "published_date";--> statement-breakpoint
ALTER TABLE "articles" DROP COLUMN "duration";--> statement-breakpoint
ALTER TABLE "authors" DROP COLUMN "local_name";--> statement-breakpoint
ALTER TABLE "categories" DROP COLUMN "local_name";--> statement-breakpoint
ALTER TABLE "editors" DROP COLUMN "deleted_by";--> statement-breakpoint
ALTER TABLE "sub_categories" DROP COLUMN "local_name";--> statement-breakpoint
ALTER TABLE "tags" DROP COLUMN "local_name";--> statement-breakpoint
ALTER TABLE "article_tags" ADD CONSTRAINT "article_tags_article_tag_unique" UNIQUE("article_id","tag_id");
